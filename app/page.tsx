  ...
  return (
    <main className="mx-auto min-h-screen max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      <div className="mb-10 flex flex-col gap-4 rounded-[2rem] border border-white/10 bg-white/5 p-8 backdrop-blur md:flex-row md:items-end md:justify-between">
        ...
        <div className="grid gap-3 text-sm text-white/65 sm:grid-cols-2 lg:grid-cols-3 lg:min-w-[34rem] lg:w-[34rem]">
          <div className="flex h-full min-h-[7.5rem] flex-col items-center justify-between rounded-2xl border border-white/10 bg-black/20 p-4 transition-all duration-200 ease-out hover:-translate-y-1 hover:scale-[1.01] hover:border-white/18 hover:bg-black/28 hover:shadow-[0_14px_30px_rgba(0,0,0,0.18)]">
